...
const workflowSteps = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 9, title: "9. Customer Update", desc: "ระบบส่งอัปเดตความคืบหน้าให้ลูกค้าดู (ลิงก์พิเศษสำหรับลูกค้า)", icon: <CheckSquare size={24} />, color: "bg-amber-100 text-amber-700", border: "border-amber-200", role: "Customer", path: "//customer-update" }, // อนาคตลิงก์ไปหน้า Customer Tracking
